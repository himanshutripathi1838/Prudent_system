...
const WHY = [
  {
    ...
    text: "Vibration, heat, unreliable links and long service lives — engineering with consequences.",
    Icon: BriefcaseBusiness,
  },
  {
    title: "Full-stack of the physical world",
    text: "Move between firmware, acquisition, pipelines and models instead of one narrow layer.",
    Icon: GraduationCap,
  },
  {
    title: "Small teams, wide ownership",
    text: "Engineers see their work reach the plant floor, not a backlog.",
    Icon: Users,
  },
  {
    title: "Domain depth",
    text: "Industrial and railway domains reward expertise that compounds over years.",
    Icon: Award,
  },
];
      ...
      <Section className="pt-4">
        ...
        <GlassCard className="mt-8 p-6">
          <p className="text-sm text-muted-foreground">
            Official workplace photography and team highlights are published here once supplied by
            the company. We do not publish stock imagery presented as our workplace or people.
          </p>
        </GlassCard>
      </Section>
        ...
        <div className="mt-8">
          {JOBS.length > 0 ? (
            ...
            <GlassCard className="p-6">
              <p className="text-sm text-muted-foreground">
                There are no verified openings published at the moment. We still welcome
                applications — use the form below and tell us where you fit.
              </p>
            </GlassCard>
          )}
        </div>
    ...
    return (
      <GlassCard className="border-ok/40 p-8 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Thank you — our team reviews every application.
        </p>
      </GlassCard>
    );
  }
    ...
    <GlassCard className="p-6 sm:p-8">
      <form onSubmit={onSubmit} noValidate className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          {errors["resume"] ? (
            <p id="resume-error" className="mt-1 text-xs text-destructive">
              {errors["resume"]}
            </p>
          ) : null}
        </div>
